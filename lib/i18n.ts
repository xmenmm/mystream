...
const ID: Dict = {
  ...
  'watch.ad_cta': '🚀 Daftar Sekarang →',
  'watch.ad_skip_in': 'Skip dalam',
  'watch.ad_skip_btn': '▶ Lewati Iklan',
  'watch.layer_click': 'Klik untuk lanjut',
  ...
  'profile.stats': '📊 Statistik Saya',
  'profile.top_performing': '🏆 Performa Terbaik',
  'profile.recent_uploads': '🆕 Upload Terbaru',
  'profile.account_info': 'ℹ️ Info Akun',
  ...
  'settings.two_factor_auth': '🔐 Autentikasi Dua Faktor',
  'settings.appearance': '🎨 Tampilan',
  'settings.quick_links': '🔗 Tautan Cepat',
  'settings.security_tips': '💡 Tips Keamanan',
  'settings.old_password': 'Password lama',
  'settings.new_password_hint': '(min 6 karakter)',
  'settings.confirm_new_password': 'Konfirmasi password baru',
  'settings.match': '✓ Cocok',
  'settings.not_match': '✕ Tidak cocok',
  'settings.btn_change_pw': '💾 Ubah Password',
  'settings.btn_disable_2fa': '🔓 Matikan 2FA',
  'settings.tfa_on': '✅ 2FA aktif — login butuh kode 6-digit dari authenticator app.',
  'settings.tfa_off': '⚠ 2FA belum aktif — proteksi password saja.',
  ...
  'admin_panel.cta_text': 'Teks CTA',
  'admin_panel.cta_url': 'URL CTA',
  'admin_panel.image_fit': 'Cara Mengisi Gambar',
  'admin_panel.position': 'Posisi',
  'admin_panel.preview': 'Pratinjau',
  'admin_panel.preview_image': 'Pratinjau Gambar',
  'admin_panel.title_field': 'Judul',
  'admin_panel.note_optional': '📝 Catatan untuk user (opsional)',
  'admin_panel.search_user': 'Cari username, email, country…',
  'admin_panel.background': 'Background',
...
const EN: Dict = {
  ...
  'watch.ad_cta': '🚀 Sign Up Now →',
  'watch.ad_skip_in': 'Skip in',
  'watch.ad_skip_btn': '▶ Skip Ad',
  'watch.layer_click': 'Click to continue',
  ...
  'profile.top_performing': '🏆 Top Performing',
  'profile.recent_uploads': '🆕 Recent Uploads',
  'profile.account_info': 'ℹ️ Account Info',
  ...
  'settings.security_tips': '💡 Security Tips',
  'settings.old_password': 'Old password',
  'settings.new_password_hint': '(min 6 characters)',
  'settings.confirm_new_password': 'Confirm new password',
  'settings.match': '✓ Match',
  'settings.not_match': '✕ Does not match',
  'settings.btn_change_pw': '💾 Change Password',
  'settings.btn_disable_2fa': '🔓 Disable 2FA',
  'settings.tfa_on': '✅ 2FA active — login requires a 6-digit code from authenticator app.',
  'settings.tfa_off': '⚠ 2FA inactive — password protection only.',
  ...
  'admin_panel.cta_text': 'CTA Text',
  'admin_panel.cta_url': 'CTA URL',
  'admin_panel.image_fit': 'Image Fit',
  'admin_panel.position': 'Position',
  'admin_panel.preview': 'Preview',
  'admin_panel.preview_image': 'Preview image',
  'admin_panel.title_field': 'Title',
  'admin_panel.note_optional': '📝 Note for user (optional)',
  'admin_panel.search_user': 'Search username, email, country…',
  'admin_panel.background': 'Background',
...
const JP: Dict = {
  ...
  'watch.pip_close': '閉じる',
  'watch.ad_cta': '🚀 今すぐ登録 →',
  'watch.ad_skip_in': 'スキップまで',
  'watch.ad_skip_btn': '▶ 広告をスキップ',
  'watch.layer_click': 'クリックして続行',
  ...
  'profile.stats': '📊 マイ統計',
  'profile.top_performing': '🏆 トップパフォーマンス',
  'profile.recent_uploads': '🆕 最近のアップロード',
  'profile.account_info': 'ℹ️ アカウント情報',
  'profile.recent_activity': '🔔 最近のアクティビティ',
  ...
  'settings.security_score': '🛡 セキュリティスコア',
  'settings.two_factor_auth': '🔐 二段階認証',
  'settings.appearance': '🎨 外観',
  'settings.quick_links': '🔗 クイックリンク',
  'settings.security_tips': '💡 セキュリティのヒント',
  'settings.old_password': '現在のパスワード',
  'settings.new_password_hint': '(6文字以上)',
  'settings.confirm_new_password': '新しいパスワードを確認',
  'settings.match': '✓ 一致',
  'settings.not_match': '✕ 不一致',
  'settings.btn_change_pw': '💾 パスワード変更',
  'settings.btn_disable_2fa': '🔓 2FAを無効化',
  'settings.tfa_on': '✅ 2FA有効 — ログインに認証アプリの6桁コードが必要。',
  'settings.tfa_off': '⚠ 2FA無効 — パスワード保護のみ。',
  ...
  'admin_panel.cta_text': 'CTAテキスト',
  'admin_panel.cta_url': 'CTA URL',
  'admin_panel.image_fit': '画像フィット',
  'admin_panel.position': '位置',
  'admin_panel.preview': 'プレビュー',
  'admin_panel.preview_image': '画像プレビュー',
  'admin_panel.title_field': 'タイトル',
  'admin_panel.note_optional': '📝 ユーザー向けメモ（任意）',
  'admin_panel.search_user': 'ユーザー名、メール、国を検索…',
  'admin_panel.background': '背景',
  'common.activate': '有効化',
...
const AR: Dict = {
  ...
  'watch.ad_cta': '🚀 سجل الآن ←',
  'watch.ad_skip_in': 'تخطي خلال',
  'watch.ad_skip_btn': '▶ تخطي الإعلان',
  'watch.layer_click': 'انقر للمتابعة',
  ...
  'profile.top_performing': '🏆 الأكثر أداء',
  'profile.recent_uploads': '🆕 آخر التحميلات',
  'profile.account_info': 'ℹ️ معلومات الحساب',
  ...
  'settings.security_score': '🛡 درجة الأمان',
  'settings.two_factor_auth': '🔐 مصادقة ثنائية',
  'settings.appearance': '🎨 المظهر',
  'settings.quick_links': '🔗 روابط سريعة',
  'settings.security_tips': '💡 نصائح الأمان',
  'settings.old_password': 'كلمة المرور القديمة',
  'settings.new_password_hint': '(6 أحرف على الأقل)',
  'settings.confirm_new_password': 'تأكيد كلمة المرور الجديدة',
  'settings.match': '✓ متطابقة',
  'settings.not_match': '✕ غير متطابقة',
  'settings.btn_change_pw': '💾 تغيير كلمة المرور',
  'settings.btn_disable_2fa': '🔓 إلغاء 2FA',
  'settings.tfa_on': '✅ 2FA مفعّل — تسجيل الدخول يتطلب رمز 6 أرقام من تطبيق المصادقة.',
  'settings.tfa_off': '⚠ 2FA غير مفعّل — حماية كلمة المرور فقط.',
  ...
  'admin_panel.cta_text': 'نص CTA',
  'admin_panel.cta_url': 'رابط CTA',
  'admin_panel.image_fit': 'ملاءمة الصورة',
  'admin_panel.position': 'الموضع',
  'admin_panel.preview': 'معاينة',
  'admin_panel.preview_image': 'معاينة الصورة',
  'admin_panel.title_field': 'العنوان',
  'admin_panel.note_optional': '📝 ملاحظة للمستخدم (اختياري)',
  'admin_panel.search_user': 'ابحث عن اسم مستخدم، بريد، بلد…',
  'admin_panel.background': 'الخلفية',
